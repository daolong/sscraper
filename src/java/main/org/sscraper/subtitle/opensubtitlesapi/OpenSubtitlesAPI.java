...
public class OpenSubtitlesAPI {
  ...
  public String login(String username, String password, String langauge, String useragent) throws OpenSubtitlesException {
	    List<String> params = new ArrayList<String>();
	    params.add(username);
	    params.add(password);
	    params.add(langauge);
  ...
  public List<Map<String, Object>> search(String token, File movie, LANGUAGE[] languages) throws OpenSubtitlesException {
    ...
    try {
      ...
      // TODO: use file name to query
      search = new HashMap<String, Object>();
      search.put("sublanguageid", sb.toString());
      search.put("query", "喋血江湖");
      searches.add(search);
      */
      search = new HashMap<String, Object>();
      search.put("sublanguageid", sb.toString());
